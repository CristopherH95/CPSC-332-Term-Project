...
INSERT INTO Course_Section (SecNum, CNum, Room, MDays, BegTime, EndTime, cap, Teacher)
VALUES ('03', 'CPSC-481', 'CS115', ('Tue, Thu'), '17:30:00', '18:45:00', 24, (SELECT SSN FROM Professor WHERE P_Name = 'Billy Jean'));

INSERT INTO Course_Section (SecNum, CNum, Room, MDays, BegTime, EndTime, cap, Teacher)
VALUES ('03', 'MATH-125', 'MH256', ('Tue'), '11:30:00', '12:45:00', 25, (SELECT SSN FROM Professor WHERE P_Name = 'Shawn Wang'));
